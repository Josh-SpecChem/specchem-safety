            ...
            {showResult && (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <CheckCircle
                    className={`h-5 w-5 ${isCorrect ? "text-green-600" : "text-red-600"}`}
                  />
                  <span
  ...
  const sections: Section[] = [
          ...
          <Card className="border-l-4 border-l-blue-500">
            <CardContent className="pt-6">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">
                Bienvenido a la Capacitación Específica por Función de SpecChem
              </h2>
              <p className="text-lg leading-relaxed text-gray-700 mb-6">
                Este curso integral de capacitación cubre los requisitos y
                expectativas para el manejo, empaque y envío de materiales
                regulados por DOT en su trabajo en SpecChem.
              </p>

              <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 mb-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Por Qué Importa Esta Capacitación
                </h3>
                <p className="text-gray-700 mb-4">
                  <strong>
                    El Título 49 del Código de Regulaciones Federales
                  </strong>{" "}
                  requiere que cualquier asociado que empaque, maneje o
                  transporte materiales peligrosos debe recibir capacitación
                  cada tres años sobre los siguientes temas de materiales
                  peligrosos:
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "Familiarización con varios aspectos involucrados con materiales peligrosos",
                  },
                  {
                    title: "Capacitación Específica por Función",
                    desc: "Cómo se manejan los materiales peligrosos en su trabajo específico",
                  },
                  {
                    title: "Capacitación de Seguridad",
                    desc: "Manejo seguro de materiales peligrosos",
                  },
                  {
                    title: "Conciencia de Seguridad",
                    desc: "Problemas de seguridad de HAZMAT",
                  },
                  {
                    title: "Seguridad Profunda",
                    desc: "Capacitación detallada sobre mantener la seguridad al tratar con materiales peligrosos",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
            ...
            <CardContent className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-lg leading-relaxed text-gray-700">
                  No se espera que recuerde toda la información detallada, pero
                  debe estar consciente de lo que distingue los materiales de
                  empaque utilizados para materiales regulados por DOT del
                  empaque estándar.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-gray-900">
                  ¿Qué Hace Especial al Empaque Calificado UN?
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  Las calificaciones UN para empaque se desarrollaron para que
                  el transporte de materiales peligrosos fuera más seguro y más
                  fácil. Si un material está regulado por DOT, debe mantenerse
                  en empaque calificado UN, ya sea para almacenamiento o para
                  transporte.
                </p>
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-6">
                  <div className="bg-white border border-gray-200 rounded-lg p-4 text-center">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-2">
                      Calificación Multifacética
                    </h4>
                    <p className="text-sm text-gray-600">
                      Letras y números marcados permanentemente en contenedores
                    </p>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Serie de pruebas para demostrar conformidad con estándares
                    </p>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      El Departamento de Transporte de EE.UU. aplica las
                      regulaciones
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-4 text-gray-900">
                  Estándares de Prueba Integrales
                </h3>
                <p className="text-gray-700 mb-4">
                  Las pruebas de contenedores de empaque incluyen múltiples
                  evaluaciones rigurosas:
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    {
                      test: "Prueba de Presión Externa",
                      purpose:
                        "Asegurar que los contenedores puedan resistir cambios en la presión externa sin fallar",
                    },
                    {
                      test: "Prueba de Presión Interna",
                      purpose:
                        "Asegurar que los contenedores no fallen bajo condiciones de presión interna",
                    },
                    {
                      test: "Prueba de Soporte de Peso",
                      purpose:
                        "Los contenedores pueden soportar peso por períodos extendidos a alta temperatura sin fallar",
                    },
                    {
                      test: "Prueba de Vibración",
                      purpose:
                        "Los contenedores pueden resistir vibraciones que ocurren durante el transporte",
                    },
                    {
                      test: "Prueba de Caída",
                      purpose:
                        "Los contenedores pueden resistir caídas libres que pueden ocurrir durante el transporte",
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
...

    {
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Se requiere empaque calificado UN si el material que se empaca
                  para transporte está clasificado como cualquiera de los
                  siguientes:
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  {
                    type: "Sustancia infecciosa",
                    emoji: "🦠",
                    class: "Clase 6.2",
                  },
                  { type: "Material corrosivo", emoji: "⚠️", class: "Clase 8" },
                  {
                    type: "Sólido inflamable",
                    emoji: "🔥",
                    class: "Clase 4.1",
                  },
                  { type: "Oxidante", emoji: "💨", class: "Clase 5.1" },
                  {
                    type: "Peróxido orgánico",
                    emoji: "🧪",
                    class: "Clase 5.2",
                  },
                  {
                    type: "Materiales tóxicos",
                    emoji: "☠️",
                    class: "Clase 6.1",
                  },
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">
                  Materiales Comunes de SpecChem
                </h3>
                <p className="text-gray-700 mb-4">
                  En SpecChem, los materiales que manejará que requieren empaque
                  calificado UN serán principalmente:
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">
                      Sustancias químicas que causan daño
                    </p>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <h4 className="font-semibold text-gray-900 mb-2">
              ...
              <div className="bg-red-100 border-2 border-red-300 rounded-lg p-6">
                ...
                <div className="bg-white border border-red-300 rounded p-4">
                  <p className="text-gray-700 font-medium">
                    Porque el empaque calificado UN está diseñado, probado y
                    regulado para asegurar el envío y almacenamiento más seguro
                    de materiales peligrosos,{" "}
                    <strong>nunca es aceptable</strong> sustituir empaque no
                    calificado UN cuando se trabaja con materiales clasificados
                    como peligrosos. <strong>No hay excepciones.</strong>
                  </p>
                </div>
              </div>
            </CardContent>
      ...
      quiz: {
        ...
        correctAnswer: "Falso",
        explanation:
          "Nunca es permitido bajo ninguna circunstancia empacar material peligroso en empaque no calificado UN. No hay absolutamente ninguna excepción a esta regla.",
      },
    },

    {
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                Como resultado, siempre debe prestar atención al tipo de empaque
                que está usando para cualquier material, para que los materiales
                regulados por DOT sean empacados en el contenedor apropiado, y
                que el contenedor esté cerrado apropiadamente.
              </p>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    Responsabilidad del DOT
                  </h3>
                  <p className="text-gray-700 mb-4">
                    Aprendimos anteriormente que el DOT tiene la responsabilidad
                    de asegurar el cumplimiento con las regulaciones
                    relacionadas con el manejo y transporte de materiales
                    peligrosos.
                  </p>
                  <div className="bg-white rounded p-3">
                    <p className="text-sm text-gray-600 font-medium">
                      El Departamento de Transporte de EE.UU. aplica todas las
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    <strong>expedidor</strong> asegurarse de que las operaciones
                    que involucran materiales regulados por DOT estén en
                    cumplimiento.
                  </p>
                  <div className="space-y-2">
                    {[
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  <strong>tanto corporativa como individualmente</strong>,
                  asegurarnos de que estamos comprando y usando el empaque
                  apropiado, y que el material esté apropiadamente identificado
                  para envío.
                </p>
                ...
                <div className="bg-white border border-red-300 rounded-lg p-4">
                  ...
                  <p className="text-gray-700">
                    <strong>
                      El no cumplir con esta responsabilidad puede ser costoso.
                    </strong>
                  </p>
                </div>
              </div>
      ...
      quiz: {
        ...
        question:
          "¿Cuál de las siguientes declaraciones no es verdadera sobre el empaque calificado UN?",
        options: [
        ...
        correctAnswer: "B",
        explanation:
          "La aplicación de las regulaciones UN actuales es realmente responsabilidad del Departamento de Transporte (DOT), no del FBI.",
      },
    },
      ...
      content: (
        <div className="space-y-8">
          <Card>
            ...
            <CardContent className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                Al trabajar con materiales regulados por DOT, debe saber dónde
                encontrar información sobre qué tipo de empaque usar y cómo
                empaquetarlo apropiadamente.
              </p>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    1. Hoja de Datos de Seguridad (SDS)
                  </h3>
                  <p className="text-gray-700 mb-4">
                    La <strong>fuente primaria</strong> de información sobre
                    empaque para cualquier material regulado por DOT.
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm">
                        Información de clasificación DOT
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm">
                        Requisitos de empaque específicos
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    2. Regulaciones CFR Título 49
                  </h3>
                  <p className="text-gray-700 mb-4">
                    Las regulaciones federales completas para el transporte de
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  Información Clave en la SDS
                </h3>
                <p className="text-gray-700 mb-4">
                  En la Sección 14 de la SDS, encontrará la información de
                  transporte más importante:
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    {
                      term: "Nombre Apropiado de Envío UN",
                      desc: "El nombre oficial para el transporte",
                    },
                    {
                      term: "Número de Identificación",
                      desc: "Número UN de 4 dígitos",
                    },
                    {
                      term: "Clase de Peligro",
                      desc: "Categoría de material peligroso",
                    },
                    {
                      term: "Grupo de Empaque",
                      desc: "Nivel de peligro (I, II, o III)",
                    },
                    {
                      term: "Peligros Ambientales",
                      desc: "Si es peligroso para el medio ambiente",
                    },
                    {
                      term: "Precauciones Especiales",
                      desc: "Requisitos adicionales de transporte",
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
...

    {
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Todo empaque que contenga material regulado por DOT debe estar
                  marcado con información específica antes del envío.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        label: "Nombre Apropiado de Envío UN",
                        example: "UN1263, Pintura",
                      },
                      {
                        label: "Número de Identificación UN",
                        example: "UN1263",
                      },
                      {
                        label: "Nombre y Dirección del Expedidor",
                        example: "SpecChem, 123 Main St.",
                      },
                      {
                        label: "Nombre y Dirección del Destinatario",
                        example: "Cliente ABC, 456 Oak Ave.",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700 mb-4">
                    Las etiquetas visuales comunican los peligros específicos
                    del material.
                  </p>
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div
                        key={index}
                        className={`${label.color} border rounded-lg p-3 text-center`}
                      >
      ...
      quiz: {
        ...
        type: "multiple-choice",
        question:
          "¿Cuál es la fuente primaria de información sobre requisitos de empaque para materiales regulados por DOT?",
        options: [
        ...
        correctAnswer: "B",
        explanation:
          "La Hoja de Datos de Seguridad (SDS) es la fuente primaria de información sobre clasificación DOT y requisitos de empaque para cualquier material regulado.",
      },
    },
      ...
      content: (
        <div className="space-y-8">
          <Card>
            ...
            <CardContent className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                El cierre apropiado del empaque calificado UN es crítico para
                mantener la integridad del contenedor y cumplir con las
                regulaciones de seguridad.
              </p>

              <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  ¿Por Qué es Importante el Cierre Apropiado?
                </h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-3">
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    Herramientas de Cierre Apropiadas
                  </h3>
                  <div className="space-y-4">
                    {[
                      {
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 font-medium">
                  <strong>
                    Use solo las herramientas y métodos especificados para el
                    cierre del empaque UN.
                  </strong>{" "}
                  El uso de herramientas improvisadas o métodos no aprobados
                  puede comprometer la integridad del empaque y violar las
...

    {
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <p className="text-gray-700">
                  En SpecChem, la seguridad siempre viene primero. Estos
                  procedimientos aseguran que manejamos materiales peligrosos de
                  manera segura y en cumplimiento con todas las regulaciones.
                </p>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Si tiene preguntas o necesita ayuda con el manejo de
                  materiales peligrosos:
                </p>
      ...
      quiz: {
        ...
        type: "true-false",
        question:
          "Es aceptable usar una llave estándar en lugar de una llave de torsión para cerrar tambores con material regulado por DOT, siempre que esté bien apretado.",
        correctAnswer: "Falso",
        explanation:
          "Debe usar solo las herramientas especificadas para el cierre del empaque UN. El uso de herramientas improvisadas puede comprometer la integridad del empaque y violar las regulaciones federales.",
      },
    },

    {
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="text-center py-8 bg-green-50 rounded-xl">
                ...
                <p className="text-xl text-gray-600 mb-6">
                  Ha completado con éxito la Capacitación Específica por Función
                  para Materiales Peligrosos
                </p>
                <Badge
                  variant="outline"
                  className="text-lg px-6 py-3 bg-green-100 border-green-300"
                >
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Al completar esta capacitación, usted se compromete a manejar
                  materiales peligrosos de manera segura y responsable. Recuerde
                  que la seguridad es responsabilidad de todos, y su adherencia
                  a estos procedimientos protege no solo a usted mismo, sino
                  también a sus compañeros de trabajo, al público y al medio
                  ambiente.
                </p>

                <div className="mt-6 p-4 bg-blue-100 border border-blue-300 rounded-lg">
                  <p className="text-blue-800 font-medium text-center">
                    &quot;En SpecChem, la seguridad no es negociable. Cada
                    procedimiento tiene un propósito, y cada empleado capacitado
                    hace la diferencia.&quot;
                  </p>
                </div>
              </div>
              ...
              <div className="text-center py-6">
                <p className="text-gray-600 mb-4">
                  Esta capacitación cumple con los requisitos del Título 49 CFR
                  para Capacitación Específica por Función
                </p>
                <p className="text-sm text-gray-500">
                  Fecha de Finalización:{" "}
                  {new Date().toLocaleDateString("es-ES")} | Válida hasta:{" "}
                  {new Date(
      ...
      quiz: {
        ...
        type: "multiple-choice",
        question:
          "¿Con qué frecuencia se requiere recertificación para la capacitación de materiales peligrosos según las regulaciones federales?",
        options: ["Cada año", "Cada 2 años", "Cada 3 años", "Cada 5 años"],
        correctAnswer: "C",
        explanation:
          "Las regulaciones federales del Título 49 CFR requieren que la capacitación de materiales peligrosos se renueve cada 3 años para mantener el cumplimiento.",
      },
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="flex max-w-7xl mx-auto">
        {/* Sidebar */}
        <div
          className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 fixed lg:sticky top-16 left-0 z-30 w-80 h-screen bg-white border-r border-gray-200 transition-transform duration-300 ease-in-out overflow-y-auto`}
        >
          <div className="p-6">
              ...
              {sections.map((section, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <section.icon
                      className={`h-5 w-5 ${currentSection === index ? "text-blue-600" : "text-gray-400"}`}
                    />
                    <div>
