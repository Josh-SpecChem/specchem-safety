/**
 * Drizzle Database Schema - Source of Truth
 * 
 * This is the authoritative database schema definition for the SpecChem Safety Training system.
 * All changes to the database structure MUST start here, then cascade through:
 * 1. Generate migration: `pnpm drizzle:gen`
 * 2. Update Zod contracts in base.ts
 * 3. Update API validation
 * 4. Update mappers
 * 
 * Multi-tenant LMS/CRM system with plant-based isolation.
 */
...
// ========================================
// ENUMS (Database Source of Truth)
// ========================================
...
// ========================================
// CORE TABLES (Plant-based Multi-tenancy)
// ========================================

/**
 * Plants - Tenant isolation boundary
 * Each plant is an independent tenant with full data isolation
 */
...
/**
 * Courses - Training content definitions
 * Global courses available to all plants
 */
...
/**
 * Profiles - User accounts with plant association
 * Each user belongs to exactly one plant (tenant isolation)
 */
 ...
 * Users can have admin roles scoped to specific plants
 */
 ...
 * Links users to courses within their plant context
 */
...
/**
 * Progress - User course completion tracking
 * Tracks detailed progress through course content
 */
...
/**
 * Activity Events - User interaction tracking
 * Records all user activities for analytics and compliance
 */
...
/**
 * Question Events - Assessment response tracking
 * Records all quiz/assessment interactions for detailed analytics
 */
...
/**
 * All queries MUST include plant-based filtering for tenant isolation.
 * Use these helper types to ensure proper tenant scoping.
 */
export type PlantScopedQuery<T> = T & { plantId: string };
export type TenantContext = { plantId: string; userId?: string };
...
// Note: Enums are already exported above, no need to re-export
